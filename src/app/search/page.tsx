  ...
  <form onSubmit={handleSearch} className='max-w-2xl mx-auto'>
    <div className='relative h-12 w-full'>
      ...
      <input
        ...
        autoComplete='off'
         className='px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-green-500 focus:border-transparent'  style={{ fontSize: '16px' }}
      />
